...
func main() {
	var (
		...
		producers   = flag.Uint("producers", defaultNumProducers, "total number of producers")
		consumers   = flag.Uint("consumers", defaultNumConsumers, "total number of consumers")
